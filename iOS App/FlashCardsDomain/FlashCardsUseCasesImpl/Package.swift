...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "FlashCardsRepositoriesImpl", path: "../../MockedData/FlashCardsRepositoriesImpl"),
    ...
    targets: [
        ...
        .target(
            name: "FlashCardsUseCasesImpl",
            dependencies: ["FlashCardsUseCases", "FlashCardsRepositoriesImpl", "FlashCardsRepositoriesRealmImpl"]),
        .testTarget(
